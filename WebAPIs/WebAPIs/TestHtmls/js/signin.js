...
$(function() {
    var signin = function(input_account, input_password) {
        var uri = 'http://221.239.197.176/api/Account/SignIn';

        console.log(input_account + "  " + input_password );

        var postData = { account: input_account, passwd: input_password };

        // $.getJSON('http://221.239.197.176/api/Doctor/GetAllTreatment')
        //     .done(function (data) {
        //         console.log(data);
        // });

        // redirect(input_account);
        ...
        $.ajax({
            ...
            success: function(data, status) {
                ...
                // $.ajax({
                //     headers: {'Access-Control-Allow-Origin' : '114.215.117.147' },
                //     type: "GET",
                //     url: 'http://221.239.197.176/api/Doctor/GetAllTreatment',
                //     xhrFields: {
    ...
    var signup = function(input_name, input_ID, input_birth, input_password) {
        var uri = 'http://221.239.197.176/api/Account/SignUp';
        ...
        console.log(input_name + "  "+ input_ID + "  " + input_sex + " " + input_birth.toString() +  "  " + input_password + " Ori:" + input_birth);
